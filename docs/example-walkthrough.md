...
Published as damf:bafyreiafdahcxo4ti7rblybwry5pivft7yziualgtuqwctqosfpnvecihy
```

As usual, this can be [browsed in IPLD explorer][explore-abella]. This link refers to the whole collection of assertions generated by the above `abella` command.

The assertion corresponding to the final `fib_squares` theorem is the last one of the assertions in the above collection. It can be browsed [starting from the collection's root cid](https://explore.ipld.io/#/explore/bafyreiafdahcxo4ti7rblybwry5pivft7yziualgtuqwctqosfpnvecihy/elements/32).
It can also be accessed [directly by its own cid](https://explore.ipld.io/#/explore/bafyreicoiuyq4nbtoz6iyyp7obwhmdsyio4alfrvaux6ichcs2f7gqgxju).

[explore-abella]: https://explore.ipld.io/#/explore/bafyreiafdahcxo4ti7rblybwry5pivft7yziualgtuqwctqosfpnvecihy
